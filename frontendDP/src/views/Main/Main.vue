...
<<<<<<< HEAD
              <rect x="30" y="20" width="10" height="10" :fill="colorMap['blue-normal']"></rect>
...
<<<<<<< HEAD
              ...
              <rect x="30" y="13" width="10" height="10" :fill="colorMap['risk']"></rect>
              <text x="45" y="22">Differential query condition</text>
              <rect v-for="(d, i) in queryNumLegend"
                    ...
                    :fill="d"
              ></rect>
              <text x="50" y="35" text-anchor="end">{{MinRecordsNum}}</text>
              <text x="135" y="35">{{MaxRecordsNum}}</text>
              <text x="40" y="45"># Records in query result</text>
            </svg>
...
<<<<<<< HEAD
      ...
      <div id="AS_Panel" class="Panel">
        ...
        <div v-if="QueryAttrType !== 'categorical'">
          ...
          <el-button type="primary" @click="switchPercentage1"><el-icon><Refresh /></el-icon></el-button>
        </div>
      ...
      <div id="GQS_Panel" class="Panel">
        ...
        <div v-if="QueryAttrType !== 'categorical'">
          ...
          <el-button type="primary" @click="switchPercentage2"><el-icon><Refresh /></el-icon></el-button>
        </div>
...
<<<<<<< HEAD
        let outerPieColor = [this.colorMap["deep-risk"], this.colorMap["deep-blue-normal"]];
        let innerPieColor = [this.colorMap["risk"], this.colorMap["blue-normal"]];
=======
