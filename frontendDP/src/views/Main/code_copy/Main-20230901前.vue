...
<!--&lt;!&ndash;              <rect x="0" y="21" width="10" height="10" :fill="colorMap['risk']"></rect>&ndash;&gt;-->
...
<!--&lt;!&ndash;              <g class="attrRiskSlider" transform="translate(0,0)">&ndash;&gt;-->
<!--&lt;!&ndash;                <line x1="115" x2="125" y1="2" y2="2" stroke="#666" stroke-width="2px"></line>&ndash;&gt;-->
<!--&lt;!&ndash;                <line x1="120" x2="120" y1="2" y2="18" stroke="#666" stroke-width="3px"></line>&ndash;&gt;-->
<!--&lt;!&ndash;                <line x1="115" x2="125" y1="18" y2="18" stroke="#666" stroke-width="2px"></line>&ndash;&gt;-->
<!--&lt;!&ndash;              </g>&ndash;&gt;-->
...
export default {
    ...
    methods: {
      ...
      dataProcessing(data, IncludeAttr, ExcludeAttr) {
        let attrs = data.attrs;
        let attrNum = attrs.length;
        let Quadruple = data.Quadruple;
